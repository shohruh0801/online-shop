...
$ins = mysqli_query($conn,"INSERT INTO corusel ( img, header, title) VALUES ('$img_name','$header','$title')");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div id="sidebar">
    ...
    <ul class="list-unstyled components mn">
       ...
       <li>
        ...
        <li>
            <a href="productscard.php">Product Corusel</a>
        </li>
        <li>
...
if (isset($_GET['id'])) {
$id = $_GET['id'];
$del = mysqli_query($conn, "DELETE FROM corusel WHERE id='$id'");
}
