<?php
require "db.php";
$admininform = mysqli_query($conn, "SELECT * FROM productscard");
...
$ins = mysqli_query($conn,"INSERT INTO productscard ( img, header, price, title) VALUES ('$img_name','$header','$price','$title')");
}
?>
<!DOCTYPE html>
<html lang="en">
...
if (isset($_GET['id'])) {
$id = $_GET['id'];
$del = mysqli_query($conn, "DELETE FROM productscard WHERE id='$id'");
}
...
<h5 class="card-title"><?php echo $serrow['price'] ?></h5>
