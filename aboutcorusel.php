<?php
require "db.php";
$admininform = mysqli_query($conn, "SELECT * FROM aboutcorusel");
...
if (isset($_FILES['img']) && isset($_POST['title']) && isset($_POST['header'])  ){
 ...
 $updt = mysqli_query($conn,"UPDATE aboutcorusel SET img='$img_name', header= '$header', title='$title'");
...
if (isset($_GET['id'])) {
$id = $_GET['id'];
$del = mysqli_query($conn, "DELETE FROM aboutcorusel WHERE id='$id'");
}
$serinform = "SELECT * FROM aboutcorusel";
