<?php
require "db.php";
$admininform = mysqli_query($conn, "SELECT * FROM aboutcard");
...
$insweb = mysqli_query($conn,"INSERT INTO aboutcard ( img, header, price, title) VALUES ('$img_name','$header','$price','$title')");
}
?>
<!DOCTYPE html>
<html lang="en">
