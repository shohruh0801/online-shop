<?php
require "db.php";
$admininform = mysqli_query($conn, "SELECT * FROM cards");
...
$ins = mysqli_query($conn,"INSERT INTO cards ( img, header, price, title) VALUES ('$img_name','$header','$price','$title')");
}
?>
<!DOCTYPE html>
<html lang="en">
...
if (isset($_GET['id'])) {
$id = $_GET['id'];
$del = mysqli_query($conn, "DELETE FROM cards WHERE id='$id'");
}
