<?php
require "db.php";
$admininform = mysqli_query($conn, "SELECT * FROM contactcorusel");
...
if (isset($_FILES['img']) && isset($_POST['title']) && isset($_POST['header'])  ){
 ...
 $updt = mysqli_query($conn,"UPDATE contactcorusel SET img='$img_name', header= '$header', title='$title'");
...
if (isset($_GET['id'])) {
$id = $_GET['id'];
$del = mysqli_query($conn, "DELETE FROM contactcorusel WHERE id='$id'");
}
$serinform = "SELECT * FROM contactcorusel";
